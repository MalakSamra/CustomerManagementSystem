...
public class CustomerUserManager : ICustomerUserManager
{
    ...
    public CustomerUserDto? GetById(int cstId)
    {
        ...
        return new CustomerUserDto 
        {
            ...
            CustomerId = cuFromDB.CustomerId,
    ...
    {
        Customer_User? cu = _customerUserRepo.GetById(cst_usrFromRequest.CustomerId);
        if (cu == null) { return false; }
        cu.UserID = cst_usrFromRequest.UserID;
        cu.CustomerId = cst_usrFromRequest.CustomerId;
